...
<div class="sidebar">
    ...
    <ul id="nav">
        ...
        <li><a href="{{ Request::root() }}/admin/home" class="open"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
         ...
         <li class="has_sub"><a href="#"><i class="fa fa-list-alt"></i> <span>{{ trans("common.item") }}</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>
            <ul>
                <li><a href="{{ Request::root() }}/admin/item/all">{{ trans("common.all") }}</a></li>
                <li><a href="{{ Request::root() }}/admin/item/create">{{ trans("common.add") }}</a></li>
